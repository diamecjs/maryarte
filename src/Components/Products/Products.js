                ...
                <div class="px-5 pb-5">
                    ...
                    <div class="flex items-center mt-2.5 mb-5">
                        ...
                        {typeof isLoggedIn === "boolean" && isLoggedIn ? (
                           <img class="m-5" src="https://res.cloudinary.com/dsjsbp6qy/image/upload/v1682526413/external-Delete-round-icons-others-inmotus-design-removebg-preview_zzrfln.png" width={30} onClick={() => handleDelete(id)} style={{cursor: "pointer"}}/>
                        ) : null}
                        {typeof isLoggedIn === "boolean" && isLoggedIn ? (
                            <img src="https://res.cloudinary.com/dsjsbp6qy/image/upload/v1682526413/external-edit-user-interface-febrian-hidayat-gradient-febrian-hidayat-removebg-preview_zsj3p1.png" width={30} onClick={() => handleEdit(id)} style={{cursor: "pointer"}}/>
                        ) : null}
                        </div>
                    </div>
